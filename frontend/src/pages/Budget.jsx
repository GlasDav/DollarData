...
export default function Budget() {
    ...
    return (
        <div className="max-w-7xl mx-auto p-8">
            ...
            <div data-tour="budget-tabs" className="flex gap-1 border-b border-slate-200 dark:border-slate-700 mb-6">
                {tabs.map(tab => {
                    const Icon = tab.icon;
                    ...
                    return (
                        <button
                            key={tab.id}
                            data-tour={tab.id === 'categories' ? 'categories-tab' : tab.id === 'rules' ? 'rules-tab' : undefined}
